...
import com.infoTech.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	@Autowired
	private ProductDAO producttDAO;
	...
	public ModelAndView showSingleProudct(@PathVariable("id") int id) throws ProductNotFoundException{
		ModelAndView mv = new ModelAndView("page");	
		
		Product product = producttDAO.get(id);
		
		if(product == null) throw new ProductNotFoundException();
		
		product.setViews(product.getViews()+1);
		producttDAO.update(product);
